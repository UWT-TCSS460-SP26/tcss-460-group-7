...
describe('Hello Route', () => {
    ...
    it('GET /hello/users/kassie - returns greeting message from Kassie', async () => {
        ...
        expect(response.status).toBe(200);
        expect(response.body.message).toBe('Hello! My name is Kassie Whitney. I am 33 years old. I am currently a Senior at University of Washington Tacoma! It is nice to meet everyone!');
    });
});
