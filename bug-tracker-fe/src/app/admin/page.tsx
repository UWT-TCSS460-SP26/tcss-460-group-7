...
export default function AdminDashboard() {
  ...
  const getPriorityBadge = (priority: number) => {
    const baseClasses =
      'px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter italic transition-all duration-300';
    switch (priority) {
      case 0:
        return (
          <span
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {!isAuthorized && !loading && (
          ...
          >
            <ShieldCheck
              className={cn('w-20 h-20 mb-6', theme === 'dark' ? 'text-gray-900' : 'text-gray-100')}
            />
            <h2
              className={cn(
                  ...
                  {issues.map((issue) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-5">
                        ...
                        >
                          {issue.author?.username || 'Guest'}
                        </div>
                        <div className="text-[10px] text-gray-500 font-bold uppercase tracking-widest mt-1">
                          {issue.reporterContact || 'No Contact'}
                        </div>
                      </td>
                      <td className="px-6 py-5 text-right">
                        <button
                          ...
                          className={cn(
                            ...
                            theme === 'dark'
                              ? 'text-gray-700 hover:text-red-500 hover:bg-red-500/10'
